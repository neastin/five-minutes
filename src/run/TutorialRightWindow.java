...
public class TutorialRightWindow extends Window {
    private int lapCounter = 0;
    private int lapGoal;

    public TutorialRightWindow(Player player) {
        super(player);
        lapGoal = 1;
    ...
    public void render(GameContainer container, StateBasedGame game, Graphics g, Player player) throws SlickException {
        ...
        g.drawString("Use right arrow key", 100 + player.windowPos[0], 80);
        g.drawString("or D to move to the", 100 + player.windowPos[0], 80 + 30);
        g.drawString("right of the screen", 100 + player.windowPos[0], 80 + 60);
    ...
    public void init(GameContainer container, StateBasedGame game, Player player) throws SlickException {
        ...
        playerPos[0] = player.windowPos[0] + player.pWidth;
    ...
    public void update(GameContainer container, StateBasedGame game, int delta, Player player) throws SlickException {
        ...
        if (playerPos[0] > player.windowPos[0] + player.windowSize[0] - player.pWidth) {
            lapCounter += 1;
            playerPos[0] = player.windowPos[0] + player.pWidth;
        }
